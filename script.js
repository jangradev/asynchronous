...
const renderCountry = function (data, className = '') {
  ...
  <article class="country ${className}">
    ...
    <div class="country__data">
      ...
      <p class="country__row"><span>🗣️</span>${data.name.common}</p>
    </div>
  </article>
  `;
...
const fetchData = fetch('https://restcountries.com/v3/name/Austrilla');
...
statusText: "OK"
type: "cors"
url: "https://restcountries.com/v3/name/australia"
[[Prototype]]: Response*/
...
demonyms: {eng: {…}, fra: {…}}
flag: "🇦🇺"
flags: (2) ['https://restcountries.com/data/aus.svg', 'https://restcountries.com/data/png/aus.png']
idd: {root: '+6', suffixes: Array(1)}
independent: true
landlocked: false
languages: {eng: 'English'}
latlng: (2) [-27, 133]
name: {common: 'Australia', official: 'Commonwealth of Australia', nativeName: {…}}
region: "Oceania"
